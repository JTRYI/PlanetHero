...
class ListLeaderboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int itemCount = allUsers.getLeaderboard().length > 10
        ? 10
        : allUsers.getLeaderboard().length;
      ...
      itemBuilder: (ctx, i) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: ranking == 1
                ? Colors.yellow.shade700 //if ranking is 1, return gold colour container
                : ranking == 2
                    ? Colors.blueGrey.shade200 //elif ranking is 2, return silver colour container
                    : ranking == 3
                        ? Colors.brown.shade400 //elif ranking is 3, return bronze colour container
                        : Colors.greenAccent.shade700.withOpacity(0.6), //else return green colour
          ),
          child: Row(
            children: [
              Padding(
